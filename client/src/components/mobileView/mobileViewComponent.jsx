...
export default class BasicTextField extends React.Component {
  ...
  render() {
    ...
    if(!this.state.entered){
      return (
        <form onSubmit={this.handleSubmit}>
          ...
          <TextField helperText="Enter a country to get statistics" id="filled-search" label="Country" variant="outlined" value={this.state.value} onChange={this.handleChange} />
        </form>
      );
    }
    ...
    return (
          ...
          <form onSubmit={this.handleSubmit}>
            <TextField id="filled-search" label="Country" variant="outlined" value={this.state.value} onChange={this.handleChange} />
          </form>
